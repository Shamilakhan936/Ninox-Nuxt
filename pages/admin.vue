    ...
    <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div v-else-if="!isLoggedIn" class="text-center py-12">
        <UIcon
          ...
          style="color: #6b6b6b"
        />
        <h2 class="text-2xl font-bold mb-2" style="color: #2d2d2d">
      ...
      <div v-else>
        <!-- Header -->
        <div class="mb-8">
          <h1 class="text-2xl font-bold mb-2" style="color: #2d2d2d">
            Admin Panel
          </h1>
...
const entities = [
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Full supplier location/address",
      },
      {
        key: "contactEmail",
        label: "Contact Email",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Factory location/address",
      },
      {
        key: "capacity",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        required: false,
        options: ["Installation", "Pickup", "Delivery"],
      },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "text",
        required: true,
        placeholder: "Fabric public name",
      },
      {
        key: "description",
        label: "Description",
      ...
      },
      {
        ...
        type: "text",
        required: false,
        placeholder: "Pleated Shades, Curtains",
      },
      {
        key: "transparency",
        label: "Transparency",
      ...
      {
        key: "externalPricePerMeter",
        label: "External Price/Meter",
        type: "number",
        required: false,
        placeholder: "22.60",
      },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "fabricColourId",
        label: "Fabric Colour ID",
        type: "number",
        required: true,
        placeholder: "Fabric Colour ID (number)",
      },
      {
        key: "productType",
        label: "Product Type",
      ...
      },
      {
        ...
        type: "select",
        required: true,
        options: ["Queued", "In Production", "Completed"],
      },
      {
        key: "worksheetImage",
        label: "Worksheet Image URL",
        type: "text",
        required: false,
        placeholder: "https://example.com/worksheet.jpg",
      },
    ],
  },
];
...
async function fetchData() {
  ...
  try {
    ...
    error.value = `Failed to fetch ${currentEntity.value.name.toLowerCase()}: ${
      err.message
    }`;
...
async function saveItem() {
  ...
  try {
    ...
    showNotification({
      title: "Success",
      description: `${currentEntity.value.singular} ${
        editingItem.value ? "updated" : "created"
      } successfully`,
      color: "green",
    });
    ...
    showNotification({
      title: "Error",
      description: `Failed to save ${currentEntity.value.singular.toLowerCase()}: ${
        err.message
      }`,
      color: "red",
    });
...
async function deleteItem() {
  ...
  try {
    const response = await fetch(
      `/api/${currentEntity.value.endpoint}/${deletingItem.value.id}`,
      {
        method: "DELETE",
      }
    );
    ...
    showNotification({
      title: "Error",
      description: `Failed to delete ${currentEntity.value.singular.toLowerCase()}: ${
        err.message
      }`,
      color: "red",
    });
