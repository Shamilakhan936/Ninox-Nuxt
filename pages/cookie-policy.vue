<template>
  <div class="cookie-policy-page bg-white px-8">
     <div class=" mx-auto  py-6">
      <Breadcrumb :items="breadcrumbItems" />
    </div>
    <div class=" mx-auto py-8">
      <h1 class="text-2xl font-black mb-8 text-[#2D1713] uppercase">Cookie Policy</h1>
      <div class="space-y-8 text-[#6F6259] text-base leading-8">
        <section>
          <h2 class="text-xl font-normal mb-2 text-black">1. What is a cookie?</h2>
          <p class="text-base leading-10 font-light">
            This website uses cookies. A cookie is a simple, small file that is passed on to your web browser with the pages of this website and/or Flash applications. The web browser subsequently saves the file on your computer’s hard drive. The information saved in this file can be sent back to our servers when you visit the website again. These cookies are in no way harmful to your computer.
          </p>
          <p class="text-base leading-10 font-light">
        ...
        <section>
          <h2 class="text-xl font-normal mb-2 text-black">2. The cookies we use:</h2>
          <p class="text-base leading-10 font-light">
            Crastino.com, crastinocontract.com, my.crastino.com and motion-blinds.com uses the following cookies:
          </p>
          <h3 class="text-xl font-normal mt-4 mb-1">2.1 Functional and technical cookies (necessary and session cookies)</h3>
          <p class="text-base leading-10 font-light">
            Functional and technical cookies are cookies that are necessary for the proper functioning of the Crastino.com website(s) and do not require prior consent by the user of the website. Functional cookies remember your preferences. For above mentioned sites, this includes storing a website language marker _icl_current_language, the session cookie devicePixelRatio, CraftSessionId and vuid. Please note: all these cookies are used to ensure the website’s proper functioning and guarantee increased user convenience.
          </p>
          <h4 class="text-xl font-normal mt-2 mb-1">2.1.1 Session cookies</h4>
          <p class="text-base leading-10 font-light">
            One type of cookies used on above mentioned sites are session cookies. These enable us to adjust our services to the visitor’s browsing behavior as much as possible and increase user convenience during their session. For instance, these cookies allow visitors to stay logged on during a session, etc. On Crastino.com, cookies are used to guarantee good functionality of the website on various devices. These cookies are deleted automatically when you close your browser.
          </p>
          <h3 class="text-xl font-normal mt-4 mb-1">2.2 Analytical cookies (Google Analytics)</h3>
          <p class="text-base leading-10 font-light">
          ...
          <p class="text-base leading-10 font-light">The retention period of the analytical cookies is: 26 months</p>
          <h3 class="text-xl font-normal mt-4 mb-1">2.3 Tracking cookies</h3>
          <h4 class="text-xl font-normal mt-2 mb-1">2.3.1 Pardot</h4>
          <p class="text-base leading-10 font-light">
          ...
          <p class="text-base leading-10 font-light">
            ...
            <br>visitor_id
            <br>pi_opt_in
            <br>Information acquired by Pardot cookies shall be logged for a period of 120 months.
          </p>
          <p class="text-base leading-10 font-light">
            Information acquired by Pardot is not shared with other parties outside of Crastino.
          </p>
        </section>
        <section>
          <h2 class="text-xl font-normal mb-2 text-black">3. Your rights</h2>
          <ul class="list-disc pl-6">
            <li class="text-base leading-8">the right to ask what personal data we hold about you at any time and obtain information in that regard;</li>
            <li class="text-base leading-8">the right to ask us to update and correct any out-of-date or incorrect personal data that we hold about you;</li>
            <li class="text-base leading-8">the right to erasure of your personal data (under circumstances listed in the applicable law);</li>
            <li class="text-base leading-8">the right to restrict the processing of your personal data (under circumstances listed in the applicable law);</li>
            <li class="text-base leading-8">the right to data portability (you can ask us to provide you or a third party with your personal data in a readable and accessible form);</li>
          </ul>
          <p class="text-base leading-10 font-light">
        ...
        <section>
          <h2 class="text-xl font-normal mb-2 text-black">4. Enabling and disabling cookies and removing them</h2>
          <p class="text-base leading-10 font-light">
        ...
        <section>
          <h2 class="text-xl font-normal mb-2 text-black">5. More information on cookies</h2>
          <p class="text-base leading-10 font-light">
