    ...
    <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="ml-[400px] max-w-[950px]">
          ...
          <div class="mb-[184px]">
            ...
            <p class="text-[16px] leading-[24px] text-[#6f6259] max-w-[869px]">
              Welcome to your account dashboard. Here you can manage your personal information, 
              view your company details, and access all your account features. Use the navigation 
              menu to explore different sections of your account.
            </p>
          </div>
          ...
          <div class="flex gap-[138px] mb-[120px]">
            ...
            <div class="flex-1 max-w-[402px]">
              <h2 class="text-[16px] leading-[14px] uppercase tracking-[0.2em] font-light text-[#3d3935] mb-8">
                Personal Information
              </h2>
              
              <div class="space-y-3 text-[#6f6259]">
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">First name</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ user.given_name || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">Last name</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ user.family_name || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">E-mail</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ user.email || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">Phone number</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ userProfile.phone || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">Mobile number</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ userProfile.mobile || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">Language</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ userProfile.language || 'English' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">Administrator</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ userProfile.isAdmin ? 'Yes' : 'No' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">User Profile</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ userProfile.role || 'Order products' }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="flex-1 max-w-[310px]">
              ...
              <div class="space-y-3 text-[#6f6259]">
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">Name</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ companyInfo.name || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">E-mail</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ companyInfo.email || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">Website</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ companyInfo.website || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">Country</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ companyInfo.country || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">State</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ companyInfo.state || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">Street</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ companyInfo.street || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">Postal code</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ companyInfo.postalCode || '-' }}</span>
                </div>
                
                <div class="flex justify-between items-center">
                  <span class="text-[16px] leading-[24px] font-medium">City</span>
                  <span class="text-[16px] leading-[24px] font-light">{{ companyInfo.city || '-' }}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="mb-[217px]">
            <h2 class="text-[30px] font-light text-[#2d1713] mb-[27px]">User Accounts</h2>
            
            <div v-if="otherUsers.length > 0" class="flex gap-[140px] text-[#6f6259]">
              <div>
                <div class="text-[16px] leading-[24px] font-medium mb-4">Name</div>
                <div v-for="otherUser in otherUsers" :key="otherUser.id" class="text-[16px] leading-[24px] font-light mb-2">
                  {{ otherUser.name }}
                </div>
              </div>
              
              <div>
                <div class="text-[16px] leading-[24px] font-medium mb-4">E-mail</div>
                <div v-for="otherUser in otherUsers" :key="otherUser.id" class="text-[16px] leading-[24px] font-light mb-2">
                  {{ otherUser.email }}
                </div>
              </div>
              ...
              <div>
                <div class="text-[16px] leading-[24px] font-medium mb-4">Administrator</div>
                <div v-for="otherUser in otherUsers" :key="otherUser.id" class="text-[16px] leading-[24px] font-light mb-2">
      ...
      <div v-else class="border p-6 rounded-lg shadow-sm text-center" style="background-color: #FEF2F2; border-color: #FECACA;">
        ...
        <p class="mb-4" style="color: #DC2626;">
          You don't have the necessary permissions to access the account settings.
        </p>
        <UButton
          to="/api/logout"
          external
      ...
      <UCard>
        ...
        <div class="space-y-4">
          <div class="text-sm text-gray-600 mb-4">
            Upload a CSV or Excel file with your order data. The file should contain columns for product type, dimensions, fabric details, and quantities.
          </div>
          ...
          <div v-if="selectedFile" class="p-3 bg-blue-50 rounded-lg">
            <div class="flex items-center">
              <UIcon name="i-heroicons-document" class="w-5 h-5 text-blue-600 mr-2" />
...
// Side menu items - now with route information for Orders
const sideMenuItems = [
...
const handleUpdateLanguage = async () => {
  ...
  try {
    const result = await updateLanguage(selectedLanguage.value, user.value.email)
