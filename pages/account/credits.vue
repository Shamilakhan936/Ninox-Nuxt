<template>
  <div class="ml-[86px]">
    <div class="mb-[90px]">
      <h2 class="text-3xl font-light mb-6 text-[#2D1713]">
    ...
    <div>
      ...
      <CreditTable :credits="dummyCredits" />
    </div>
  </div>
</template>
...
import CreditsSearchForm from "~/components/SearchForm.vue";
...
const dummyCredits = Array.from({ length: 10 }, () => ({
  document: "VF–2508227",
  date: "27/05/2025",
  billedTo: "Diddo ef.",
  total: "314,56",
