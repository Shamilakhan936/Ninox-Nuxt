  ...
  <div class="mx-auto md:mt-20">
    ...
    <div v-for="(item, idx) in faqs" :key="idx" class="mb-4">
      <div
        :class="[
          activeIndex === idx
            ? 'rounded-3xl border border-[#8A7C59] shadow-sm'
            : 'rounded-[66px] border [rgb(var(--Line-Light, #E2E1E1))]',
...
const faqs = [
  {
    ...
    answer:
      "You can report complaints through the complaints section in your account dashboard.",
  },
  {
    question: "How can I see the status of my complaints?",
    answer:
      "You can view the status of your complaints in the complaints section after logging in.",
  },
  {
    question: "Where can I find my credits?",
    answer:
      "Your credits are listed in the credits section of your account dashboard.",
  },
  {
