<template>
     <div class=" mx-auto py-8">
      ...
      <div class="space-y-8 text-[#6F6259] text-base leading-8">
        <div>
          <h2 class="text-xl font-normal mb-4 text-black">1. What is a cookie?</h2>
          <p class="text-base leading-[1.5] font-light mb-8">
        ...
        <div class="space-y-8">
        <div>
          <h2 class="text-xl font-normal mb-4 text-black">2. The cookies we use:</h2>
          <p class="text-base leading-[1.5] font-light">
            Crastino.com, crastinocontract.com, my.crastino.com and motion-blinds.com uses the following cookies:
          </p>
        </div>
        <div>
          <h3 class="text-xl font-normal mt-4 mb-4">2.1 Functional and technical cookies (necessary and session cookies)</h3>
          <p class="text-base leading-[1.5] font-light">
        ...
        <div>
          <h4 class="text-xl font-normal mt-2 mb-4">2.1.1 Session cookies</h4>
          <p class="text-base leading-[1.5] font-light">
        ...
        <div>
         <h3 class="text-xl font-normal mt-4 mb-4">2.2 Analytical cookies (Google Analytics)</h3>
          <p class="text-base leading-[1.5] font-light mb-8">
          ...
          <p class="text-base leading-[1.5] font-light mb-8">The retention period of the analytical cookies is: 26 months</p>
        </div>
         <div>
          <h3 class="text-xl font-normal mt-4 mb-4">2.3 Tracking cookies</h3>
         </div>
         <div>
            <h4 class="text-xl font-normal mt-2 mb-4">2.3.1 Pardot</h4>
          <p class="text-base leading-[1.5] font-light mb-8">
        ...
        <div>
          <h2 class="text-xl font-normal mb-4 text-black">3. Your rights</h2>
          <p class="text-base leading-[1.5] font-light my-4">You have the following rights:</p>
        ...
        <div>
          <h2 class="text-xl font-normal mb-4 text-black">4. Enabling and disabling cookies and removing them</h2>
          <p class="text-base leading-[1.5] font-light mb-8">
